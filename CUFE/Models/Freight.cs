...
{
    public class Freight : BasePersistentObject
    {
        ...
        {
            get => startCity;
            set => SetPropertyValue(nameof(StartCity), ref startCity, value);
        }
        ...
        {
            get => truckId;
            set => SetPropertyValue(nameof(TruckId), ref truckId, value);
        }
        //decimal loadVolume;
