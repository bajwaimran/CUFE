...
namespace FreightExchangeDemo
{

    public class FreightExchangeOrders : XPObject
    {
        static void main()
        {
            ...
            WaWiXPO.Helper.Master.MasterXpoHelper.InitiateDataLayer(connectionString);

        }
        public FreightExchangeOrders() : base()
        {
            // This constructor is used when an object is loaded from a persistent storage.
            // Do not place any code here.
        }

        public FreightExchangeOrders(Session session) : base(session)
        {
            // This constructor is used when an object is loaded from a persistent storage.
            // Do not place any code here.
        }
